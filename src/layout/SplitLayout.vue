...
<template>
  <ce-layout id="parent">
    <ce-layout-panel region="north" :size="248" :split="true" :collapsible="true">aaa</ce-layout-panel>
    <ce-layout-panel region="south" :size="148" :split="true" :collapsible="true">south</ce-layout-panel>
    <ce-layout-panel region="west" :size="220"  :split="true" :collapsible="true" :collapsedSize="100" title="Menu">menu</ce-layout-panel>
    <ce-layout-panel region="east" :size="400"  :split="true" :collapsible="true">east</ce-layout-panel>
